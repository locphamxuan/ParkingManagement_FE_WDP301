...
import { LicensePlateEditor } from '@/components/user/LicensePlateEditor';
              ...
              <form onSubmit={handleSave} className="space-y-5 rounded-3xl bg-slate-950/40 p-6 border border-white/5 animate-fadeIn">
                ...
                {user.role === 'user' && (
                  <LicensePlateEditor
                    ...
                    plateSuccess={plateSuccess}
                    setPlateError={setPlateError}
                    plateInputRef={plateInputRef}
                    onAddPlate={handleAddPlate}
                    onRemovePlate={handleRemovePlate}
                    onSetDefault={handleSetDefaultEditPlate}
                    onPlateKeyDown={handlePlateKeyDown}
                  />
                )}
