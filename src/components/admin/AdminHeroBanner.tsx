...
export function AdminHeroBanner({
  ...
  return (
    ...
    >
      ...
      {/* Bottom Reflection */}
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/25 to-transparent pointer-events-none" />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at center, rgba(0,114,255,0.4) 0%, transparent 70%)',
          filter: 'blur(20px)',
        }}
      />
      ...
      <div className="absolute top-1/2 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/25 to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col justify-between gap-5 xl:flex-row xl:items-center">
        <div className="flex items-start gap-4">
          {icon ? (
            <span
              ...
              style={{
                ...
                boxShadow: '0 4px 16px rgba(0,82,212,0.35), inset 0 1px 0 rgba(255,255,255,0.35)',
              }}
            >
              {icon}
            </span>
          ...
          <div>
            {/* Badge Chip */}
            <div
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-[0.18em] text-white font-mono shadow-sm mb-2.5"
              style={{
            ...
            <h1 className="text-2xl font-black tracking-tight text-white sm:text-[1.7rem] leading-tight" style={{ textShadow: '0 2px 8px rgba(0,20,60,0.3)' }}>
              {title}
            </h1>
            <p className="mt-2 max-w-xl text-[0.72rem] font-semibold text-white/90 leading-relaxed" style={{ textShadow: '0 1px 4px rgba(0,20,60,0.25)' }}>
              {description}
            </p>
          </div>
        </div>
