...
export function StatusBadge({ status }: StatusBadgeProps) {
  ...
  if (
    ["active", "ok", "success", "online", "low", "available"].includes(
      normalized,
    )
  ) {
    return (
  ...
  if (
    ["warning", "pending", "review", "maintenance", "medium"].includes(
      normalized,
    )
  ) {
    return (
  ...
  if (
    ["open", "investigating", "escalated", "resolved", "closed"].includes(
      normalized,
    )
  ) {
    return (
