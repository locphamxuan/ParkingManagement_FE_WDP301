    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-6 rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-6 text-sm text-slate-700">
          This is space for an in-depth management module. You can expand it into per-resource management forms, integrate the `/manager/buildings/:buildingId/...` API and display data per building.
        </div>
      </CardContent>
    </Card>
  );
