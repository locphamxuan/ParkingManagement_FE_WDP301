  ...
  return (
    <motion.article
      ...
      whileHover={module.available ? { 
        scale: 1.03, 
        y: -4, 
        boxShadow: '0 15px 35px rgba(249, 115, 22, 0.3), 0 0 20px rgba(251, 191, 36, 0.15), inset 0 0 15px rgba(249, 115, 22, 0.2)',
        borderColor: 'rgba(251, 191, 36, 0.8)' 
      } : { scale: 1.01 }}
      className={`p-5 rounded-2xl border backdrop-blur-md flex flex-col justify-between h-[230px] relative overflow-hidden transition-colors duration-300 ${
        module.available
          ? isHovered 
            ? 'bg-gradient-to-b from-slate-900/80 to-slate-950/90 shadow-[0_0_20px_rgba(249,115,22,0.15)]'
